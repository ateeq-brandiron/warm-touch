export const testimonials = {
  ...
  note: "Real words from families Cheri has helped and from partners who work alongside her. Facility names are intentionally left out of every story.",
  quotes: [
    {
      quote:
    ...
    {
      quote:
        "Cheri helped me in my move to Tucson to live in an independent living facility. In her interview, she asked what I was comfortable paying per month, what type of facility was important. Also asked about activities, health care, shopping, and closeness to family. We then visited those facilities that met most of my needs. She was at my side during the presentation, made sure I received their discounts, had a full tour, and a meal. She is very knowledgeable, professional, and does not try to influence your decision. I would highly recommend her to help any family wanting to place their loved ones in senior living facilities.",
      attribution: "Tom Claridge · Independent Living",
    },
    {
      quote:
